...
extern int aftercompression_wrapper(unsigned char * buffer, int buf_length, int maxiterations, unsigned char * in_d, unsigned char * out_d, double* encodeKernelTime);
